...
namespace AI_Strategy
{
     ...
     */
    public class CounterStratRush : AbstractStrategy
    {
        ...
        public CounterStratRush(Player player, int attackRoundAmount, int defenseLaneAmount, int defenseStartLane, int defenseDir) : base(player)
        {
